...
<section id="current-project">
    <div class="container current-project-section-container">
        ...
        <p>
            <a href="<?= htmlspecialchars($project->getWebsite()) ?>" target="_blank" title="Nouvel onglet vers le site du projet" rel="nofollow"><img src="<?= htmlspecialchars($project->getThumbnail()) ?>" alt="Aperçu - Illustration du projet" /></a>
